                                ...
                                <table width="100%" class="sub-table scrolldown" border="0"
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                            <div  class="dashboard-items search-items">
                                                ...
                                                $stmt = $database->query("SELECT petId, name FROM pet WHERE pid='$userid'");
                                                while ($petDetails = $stmt->fetch_assoc()) {
                                                    $petId = $petDetails["petId"];
                                                    $petName = $petDetails["name"];
                                                    echo '<option value="' . $petId . '">' . ucwords($petName) . '</option>';
                                                }
                                                echo '</select>
                                                        <br>
                                                </div>
                                            ...
                                            <td>';
                                                if ($stmt->num_rows >= 1) {
                                                    ...
                                                    echo "<div class='d-grid gap-2 col-6 mx-auto'>
                                                        <button class='btn btn-primary' type='button'>You don't have any pet yet...</button>
                                                    </div>";
                                                }
                                                echo '</form>
                                            </td>
