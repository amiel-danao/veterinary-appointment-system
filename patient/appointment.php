...
<body>
    ...
    //TODO
    $sqlmain = "select pet.name, appointment.pid,appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on appointment.scheduleid=schedule.scheduleid inner join patient on patient.pid=appointment.pid inner join pet on patient.pid=pet.pid inner join doctor on doctor.docid=schedule.docid where  patient.pid='$userid' and pet.petId=appointment.petId";
